...
/**
 * Force function that computes the prefuse.util.force acting on ForceItems due to a
 * given Spring.
 * 
...
public class SpringForce extends AbstractForce {
	...
	/**
	 * Calculates the prefuse.util.force vector acting on the items due to the given spring.
	 * @param s the Spring for which to compute the prefuse.util.force
