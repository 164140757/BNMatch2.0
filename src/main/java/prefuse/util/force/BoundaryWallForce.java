...
/**
 * Represents a rectangular bounding box of a boundary and applies a prefuse.util.force on
 * the prefuse.util.force items in the prefuse.util.force simulation, pushing them away from the walls of
 * this rectangle. The walls may or may not be of variable wall prefuse.util.force, depending
...
public abstract class BoundaryWallForce extends AbstractForce {
	 ...
	 * @param scaleFactor is the scale by which the wall prefuse.util.force changes
	 */
	...
	/**
	 * This method sets the scaling factor of this wall prefuse.util.force. The scaling factor
	 * is the value that the gravitational constant is multiplied by when the wall
	 * is scaled.
	 * @param scaleFactor is the new scale factor of this wall prefuse.util.force
	...
	/** 
	 * This method scales the strength of the wall prefuse.util.force in the direction of @param dir,
