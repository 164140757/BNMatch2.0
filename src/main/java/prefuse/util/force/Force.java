...
/**
 * Interface for prefuse.util.force functions in a prefuse.util.force simulation.
 *
...
public interface Force {
    ...
    /**
     * Initialize this prefuse.util.force function.
     ...
     * spring prefuse.util.force coefficient) affecting this prefuse.util.force function.
     ...
     * strictly enforced, but is used by interface components that allow prefuse.util.force
    ...
    /**
     * Indicates if this prefuse.util.force function will compute forces
     * on Spring instances.
     * @return true if this prefuse.util.force function processes Spring instances
     */
     ...
     * @return true if this prefuse.util.force function processes Force instances
     */
    public boolean isItemForce();
    
    /**
     * Updates the prefuse.util.force calculation on the given ForceItem
     * @param item the ForceItem on which to compute updated forces
     */
    public void getForce(ForceItem item);
    
    /**
     * Updates the prefuse.util.force calculation on the given Spring. The ForceItems
     * attached to Spring will have their prefuse.util.force values updated appropriately.
