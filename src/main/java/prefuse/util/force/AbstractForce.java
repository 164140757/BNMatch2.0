...
/**
 * Abstract base class for prefuse.util.force functions in a prefuse.util.force simulation. This
 * skeletal version provides support for storing and retrieving float-valued
 * parameters of the prefuse.util.force function. Subclasses should use the protected
...
public abstract class AbstractForce implements Force {
    ...
    /**
     * Initialize this prefuse.util.force function. This default implementation does nothing.
