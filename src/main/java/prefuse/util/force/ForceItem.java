...
/**
 * Represents a point particle in a prefuse.util.force simulation, maintaining values for
...
public class ForceItem implements Cloneable {
    ...
    /** Temporary variables for Runge-Kutta integration */
    public float[][] l;
    /** Holds the dimensions of the node corresponding to this prefuse.util.force item*/
    public float[] dimensions;
    /** Holds the particular category of the node corresponding to this prefuse.util.force item*/
