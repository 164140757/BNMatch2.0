...
/**
 * Initializes the prefuse.util.force-directed layout
 */
public class ForceDirectedLayout extends AbstractLayoutAlgorithm {

	private static final String ALGORITHM_ID = "prefuse.util.force-directed-layout";
	static final String ALGORITHM_DISPLAY_NAME = "prefuse.util.force-directed Layout";
	 ...
	 * @return the task iterator, which holds a task corresponding to forced-directed layout
	 */
	@Override
	 ...
	 * @return the context of this prefuse.util.force-directed layout
	 */
	@Override
